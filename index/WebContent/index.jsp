            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                     <li><a href="tablecomb.jsp"><span class="glyphicon glyphicon-file">Document Details</span></a></li>
                       <li><a href="index.jsp"><span class="glyphicon glyphicon-file">Files</span></a></li>
                        	<li><a href="help1.html"><span class="glyphicon glyphicon-earphone">Help</span></a></li>
...
<br><br>
  ...
  <form name=myname method=post action="delete1.jsp">       
...
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1">
            ...
            <button name="delete" type="submit" action="delete1.jsp" class="btn btn-info btn-lg">
...
<input type="image" src="img/m1.png"/>  
                     ...
                     <form action=add1.jsp enctype="multipart/form-data" >
    ...
    <input type="submit" value="Submit" action="add1.jsp">
  </form>
